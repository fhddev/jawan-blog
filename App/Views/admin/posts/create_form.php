        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-validation">
                    ...
                    <form class="form-valide" action="http://127.0.0.1:8000/admin/posts/create_submit" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <select class="form-control input-default" multiple id="tags" name="tags[]" data-choices="post-tags">
                                    <option value="City" <?= $model->tags !== null && in_array('City', $model->tags) ? "selected" : "" ?>>City</option>
                                    <option value="Color" <?= $model->tags !== null && in_array('Color', $model->tags) ? "selected" : "" ?>>Color</option>
                                    <option value="Creative" <?= $model->tags !== null && in_array('Creative', $model->tags) ? "selected" : "" ?>>Creative</option>
                                    <option value="Decorate" <?= $model->tags !== null && in_array('Decorate', $model->tags) ? "selected" : "" ?>>Decorate</option>
                                    <option value="Demo" <?= $model->tags !== null && in_array('Demo', $model->tags) ? "selected" : "" ?>>Demo</option>
                                    <option value="Elements" <?= $model->tags !== null && in_array('Elements', $model->tags) ? "selected" : "" ?>>Elements</option>
                                    <option value="Fish" <?= $model->tags !== null && in_array('Fish', $model->tags) ? "selected" : "" ?>>Fish</option>
                                    <option value="Food" <?= $model->tags !== null && in_array('Food', $model->tags) ? "selected" : "" ?>>Food</option>
                                    <option value="Nice" <?= $model->tags !== null && in_array('Nice', $model->tags) ? "selected" : "" ?>>Nice</option>
                                    <option value="Recipe" <?= $model->tags !== null && in_array('Recipe', $model->tags) ? "selected" : "" ?>>Recipe</option>
                                    <option value="Season" <?= $model->tags !== null && in_array('Season', $model->tags) ? "selected" : "" ?>>Season</option>
                                    <option value="Taste" <?= $model->tags !== null && in_array('Taste', $model->tags) ? "selected" : "" ?>>Taste</option>
                                    <option value="Tasty" <?= $model->tags !== null && in_array('Tasty', $model->tags) ? "selected" : "" ?>>Tasty</option>
                                    <option value="Vlog" <?= $model->tags !== null && in_array('Vlog', $model->tags) ? "selected" : "" ?>>Vlog</option>
                                    <option value="Wow" <?= $model->tags !== null && in_array('Wow', $model->tags) ? "selected" : "" ?>>Wow</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <textarea  class="form-control input-default summernote" id="content" name="content"><?= htmlspecialchars($model->content ?? '') ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
