        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-validation">
                    ...
                    <form class="form-valide" action="http://127.0.0.1:8000/admin/posts/destroy/<?= $model->post_id ?>" method="post">
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <p class="text-center h3">Are you sure you want to delete this post?</p>
                            </div>
                        </div>
                        <div class="form-group row">
