	...
	<div class="container">
		<div class="row no-gutters justify-content-center">
			<div class="col-lg-3 col-md-4 mb-4 mb-md-0">
				...
				<img class="author-image" src="/<?= $author->picture_path ?>">
				
			</div>
			<div class="col-md-8 col-lg-6 text-center text-md-left">
				<h3 class="mb-2"><?= $author->full_name ?></h2>
					<strong class="mb-2 d-block"><?= htmlspecialchars_decode($author->job_title) ?></strong>
					<div class="content">
						<p><?= htmlspecialchars_decode($author->bio) ?></p>
					...
					<div class="card-body">
						...
						<ul class="card-meta list-inline">
							<li class="list-inline-item">
								<a href="/author/<?= $author->username ?>" class="card-meta-author">
									<img src="/<?= $author->picture_path ?>">
